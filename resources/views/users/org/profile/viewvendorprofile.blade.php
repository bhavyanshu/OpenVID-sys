        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="lists">
              @if(count($vulns)<1)
                <p class="lead">No vulnerabilities have been reported against this vendor's products.</p>
              @else
                <h4>Vulnerabilities Reported against {{$elseprofile->first_name}} {{$elseprofile->last_name}}'s products</h4>
              @endif
              @foreach ($vulns as $v)
              <div class="box-body box-padding">
                ...
                <div class="col-md-12">
                  <div class="col-md-3">
                    <a href="/product/{{$v->p_id}}">{{$v->p_name}}</a>
                  </div>
                  <div class="col-md-3">
                    By {{$v->p_author_name}}
                  </div>
