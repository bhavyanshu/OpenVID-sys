              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    ...
                    @if($product->user_p_id == Auth::user()->id)
                      <div class="col-md-3">
                        <br>
                        @if($vuln->vul_status == 0)
                          <p><strong>The issue has been marked fixed</strong> but you can rollback and open this bug again or you can update patch information.</p>
                          <a class="btn btn-sm btn-success" href="/mark/resolved/{{$vuln->vul_id}}">Update Information</a>
                        @elseif($vuln->vul_status == 1)
                          <p><strong>If fixed</strong>, click mark resolved button to submit information regardng the patch that fixes this.</p>
                          <a class="btn btn-sm btn-success" href="/mark/resolved/{{$vuln->vul_id}}">Mark Resolved</a>
                        @elseif($vuln->vul_status == 2)
                          <p><strong>If fixed</strong>, click mark resolved to submit information regardng the patch.</p>
                          <a class="btn btn-sm bg-yellow" href="/mark/resolved/{{$vuln->vul_id}}">Mark Resolved</a>
                        @endif
                      </div>
                    @endif
                  </div>
